...
#   before :each do
#     reset_test_db!
#     @datasource = create_test_datasource(:title=>'Test')
#     ETL::Engine.init
...
# 
#     before :each do
#       ETL::Engine.process_string(@datasource, @test_ctl)
#     end
#     
...
#     
#   end
  it 'should run ETL Jobs to import data from a datasource into an RDFS Class'
