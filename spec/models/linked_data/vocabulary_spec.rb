...
describe LinkedData::Vocabulary do
  ...
  it 'should fail to initialize instance without a label, collection and base_uri' do
    lambda {  @bad_vocab = LinkedData::Vocabulary.new().save! }.should raise_error
    lambda {  @bad_vocab = LinkedData::Vocabulary.new(:label => @label).save! }.should raise_error
    lambda {  @bad_vocab = LinkedData::Vocabulary.new(:collection => @collection).save! }.should raise_error
    lambda {  @bad_vocab = LinkedData::Vocabulary.new(:base_uri => @uri).save! }.should raise_error
  end
